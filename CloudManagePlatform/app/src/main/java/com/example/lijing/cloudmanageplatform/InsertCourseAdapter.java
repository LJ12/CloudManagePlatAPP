...
public class InsertCourseAdapter extends BaseAdapter {
    private Context context = null;
    private List list = new ArrayList<String>();
    ;

    public InsertCourseAdapter(Context context, List list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (!list.get(position).toString().equals("")) {
            if (convertView == null) {
                ...
                mHolder.TV_ID = (TextView) convertView.findViewById(R.id.TV_CI_1);
                mHolder.TV_Name = (TextView) convertView.findViewById(R.id.TV_CI_2);
                mHolder.TV_Num = (TextView) convertView.findViewById(R.id.TV_CI_3);
            ...
            String Num = list.get(position).toString().split(" ")[2];
